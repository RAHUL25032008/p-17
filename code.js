...
var sam;
  ...
  boundary1 = createSprite(190,115,420,3);
  ...
  car1.shapeColor = "aqua";
  car2 = createSprite(215,130,10,10);
  car2.shapeColor = "aqua";
  car3 = createSprite(165,250,10,10);
  car3.shapeColor = "aqua";
  car4 = createSprite(270,250,10,10);
  car4.shapeColor = "aqua";
  car1.velocityY=3
  car2.velocityY=3
  car3.velocityY=-3
  car4.velocityY=-3
...
if (keyDown("left")) {
   ...
   if( sam.isTouching(car1)|| sam.isTouching(car2)|| sam.isTouching(car3)|| sam.isTouching(car4)) { sam.x
= 20; sam.y
= 190; life = life + 1; }
